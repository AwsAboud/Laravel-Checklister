...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ route('welcome') }}"><img
                src="{{ URL::asset('assets/img/brand/logo.png') }}" class="main-logo" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ route('welcome') }}"><img
    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/user.png') }}"><span
        ...
        <ul class="side-menu">
            ...
            @if (auth()->user()->is_admin)
                ...
                {{-- Manage   Checklist Gropus Section --}}
                ...
                @foreach ($adminMenu as $group)
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.checklist-groups.edit', $group->id) }}">
                            ...
                            <span class="side-menu__label">{{ $group->name }}</span><i
                ...
                @foreach (App\Models\Page::all() as $page)
                    <li class="slide">
                        <a class="side-menu__item" href="{{ route('admin.pages.edit', $page) }}">
                            ...
                            </svg><span class="side-menu__label">{{ $page->title }}</span></a>
                    </li>
                @endforeach

                {{-- Manage  Data Section --}}

                <li class="side-item side-item-category">{{ __('Manage  Data') }}</li>
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('admin.users.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            ...
                            <path
                                d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                        </svg><span class="side-menu__label">{{ __('Users') }}</a>
                </li>
                {{-- not admin user --}}
            @else
                ...
                <ul class="slide-menu">
                    @foreach ($group['checklists'] as $checklist)
                        <li>
                            <a class="slide-item" href="{{ route('user.checklists.show', [$checklist['id']]) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0V0z" fill="none" />
                                    <path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"
                                        opacity=".3" />
